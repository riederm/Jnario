...
@Named("Feature")
@Contains({ FeatureCompilerSpec.class, FeatureClassNameProviderSpec.class, FeatureDocGeneratorSpec.class, FeatureExecutableProviderSpec.class, FeatureJavaValidatorSpec.class, FeatureLocationInFileProviderSpec.class, FeatureQualifiedNameProviderSpec.class, FeaturesSpec.class, FeatureScopeProviderSpec.class, FeatureTokenSourceSpec.class, FeatureValueConverterSpec.class, GivenWhenThenSpec.class, IntroducingJnarioFeaturesSpec.class, ReferencingOtherStepsSpec.class, ShouldSpec.class, StepArgumentsProviderSpec.class, StepContextProviderSpec.class, StepExpressionProviderSpec.class, StepNameProviderSpec.class, StepTypeProviderSpec.class })
