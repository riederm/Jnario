 ...
 * generated by Xtext
 */
parser grammar InternalXbaseWithRichstringParser;

options {
	tokenVocab=InternalXbaseWithRichstringLexer;
...
@header {
package org.jnario.xbase.richstring.ui.contentassist.antlr.internal; 
...
@members {
 	...
 	
 	{
		...
		tokenNameToValue.put("SEPARATOR", "'SEPARATOR'");
