 ...
 * </p>
 * <ul>
 *   <li>{@link org.jnario.xbase.richstring.richstring.IfConditionStart#getRichStringIf <em>Rich String If</em>}</li>
 *   <li>{@link org.jnario.xbase.richstring.richstring.IfConditionStart#getElseStart <em>Else Start</em>}</li>
 *   <li>{@link org.jnario.xbase.richstring.richstring.IfConditionStart#getElseIfConditions <em>Else If Conditions</em>}</li>
 *   <li>{@link org.jnario.xbase.richstring.richstring.IfConditionStart#getEndIf <em>End If</em>}</li>
 * </ul>
 *
 * @see org.jnario.xbase.richstring.richstring.ProcessedRichStringPackage#getIfConditionStart()
 * @model
 * @generated
 */
public interface IfConditionStart extends LinePart {
	 ...
	 * It is bidirectional and its opposite is '{@link org.jnario.xbase.richstring.richstring.ElseStart#getIfConditionStart <em>If Condition Start</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.jnario.xbase.richstring.richstring.ProcessedRichStringPackage#getIfConditionStart_ElseStart()
	...
	/**
	 * Sets the value of the '{@link org.jnario.xbase.richstring.richstring.IfConditionStart#getElseStart <em>Else Start</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.jnario.xbase.richstring.richstring.ElseIfCondition}.
	 * It is bidirectional and its opposite is '{@link org.jnario.xbase.richstring.richstring.ElseIfCondition#getIfConditionStart <em>If Condition Start</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.jnario.xbase.richstring.richstring.ProcessedRichStringPackage#getIfConditionStart_ElseIfConditions()
	 ...
	 * @see #setEndIf(EndIf)
	 * @see org.jnario.xbase.richstring.richstring.ProcessedRichStringPackage#getIfConditionStart_EndIf()
	 * @model
	 * @generated
	 */
	EndIf getEndIf();
	...
	/**
	 * Sets the value of the '{@link org.jnario.xbase.richstring.richstring.IfConditionStart#getEndIf <em>End If</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
