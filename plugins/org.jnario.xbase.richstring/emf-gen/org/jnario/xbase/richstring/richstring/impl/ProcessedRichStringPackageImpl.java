 ...
 */
package org.jnario.xbase.richstring.richstring.impl;
...
import org.jnario.xbase.richstring.richstring.LineBreak;
import org.jnario.xbase.richstring.richstring.LinePart;
import org.jnario.xbase.richstring.richstring.Literal;
import org.jnario.xbase.richstring.richstring.PrintedExpression;
import org.jnario.xbase.richstring.richstring.ProcessedRichString;
...
public class ProcessedRichStringPackageImpl extends EPackageImpl implements ProcessedRichStringPackage {
	 ...
	 * @see org.jnario.xbase.richstring.richstring.ProcessedRichStringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ProcessedRichStringPackage init() {
		...
		XbaseWithRichstringPackage.eINSTANCE.eClass();
	...
	public void initializePackageContents() {
		...
		XbaseWithRichstringPackage theXbaseWithRichstringPackage = (XbaseWithRichstringPackage)EPackage.Registry.INSTANCE.getEPackage(XbaseWithRichstringPackage.eNS_URI);
		...
		initEReference(getProcessedRichString_RichString(), theXbaseWithRichstringPackage.getRichString(), null, "richString", null, 0, 1, ProcessedRichString.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLiteral_Literal(), theXbaseWithRichstringPackage.getRichStringLiteral(), null, "literal", null, 0, 1, Literal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getForLoopStart_Loop(), theXbaseWithRichstringPackage.getRichStringForLoop(), null, "loop", null, 0, 1, ForLoopStart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIfConditionStart_RichStringIf(), theXbaseWithRichstringPackage.getRichStringIf(), null, "richStringIf", null, 0, 1, IfConditionStart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getElseIfCondition_RichStringElseIf(), theXbaseWithRichstringPackage.getRichStringElseIf(), null, "richStringElseIf", null, 0, 1, ElseIfCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
