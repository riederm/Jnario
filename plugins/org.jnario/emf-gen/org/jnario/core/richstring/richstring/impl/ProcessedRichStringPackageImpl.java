 ...
 */
package org.jnario.core.richstring.richstring.impl;
...
import org.jnario.core.richstring.richstring.ElseIfCondition;
import org.jnario.core.richstring.richstring.ElseStart;
import org.jnario.core.richstring.richstring.EndIf;
import org.jnario.core.richstring.richstring.ForLoopEnd;
import org.jnario.core.richstring.richstring.ForLoopStart;
import org.jnario.core.richstring.richstring.IfConditionStart;
import org.jnario.core.richstring.richstring.Line;
import org.jnario.core.richstring.richstring.LineBreak;
import org.jnario.core.richstring.richstring.LinePart;
import org.jnario.core.richstring.richstring.Literal;
import org.jnario.core.richstring.richstring.PrintedExpression;
import org.jnario.core.richstring.richstring.ProcessedRichString;
import org.jnario.core.richstring.richstring.ProcessedRichStringFactory;
import org.jnario.core.richstring.richstring.ProcessedRichStringPackage;
...
public class ProcessedRichStringPackageImpl extends EPackageImpl implements ProcessedRichStringPackage {
	 ...
	 * @see org.jnario.core.richstring.richstring.ProcessedRichStringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getProcessedRichString_RichString(), theJnarioPackage.getRichString(), null, "richString", null, 0, 1, ProcessedRichString.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLiteral_Literal(), theJnarioPackage.getRichStringLiteral(), null, "literal", null, 0, 1, Literal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getForLoopStart_Loop(), ecorePackage.getEObject(), null, "loop", null, 0, 1, ForLoopStart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIfConditionStart_RichStringIf(), ecorePackage.getEObject(), null, "richStringIf", null, 0, 1, IfConditionStart.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getElseIfCondition_RichStringElseIf(), ecorePackage.getEObject(), null, "richStringElseIf", null, 0, 1, ElseIfCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
