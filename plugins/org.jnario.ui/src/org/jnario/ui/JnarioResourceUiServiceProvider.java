...
/**
 * Copied from Xtend's XtendResourceUiServiceProvider.java
 * 
 * @author Sven Efftinge - Initial contribution and API
 */
public class JnarioResourceUiServiceProvider extends DefaultResourceUIServiceProvider {

	@Inject
	public JnarioResourceUiServiceProvider(IResourceServiceProvider delegate) {
		super(delegate);
	}
